...
^WebResourceURL_WebResourceFrameName_WebResourceData_WebResourceMIMEType_WebResourceTextEncodingName_Shttps://raw.githubusercontent.com/EOSIO/Documentation/master/TechnicalWhitePaper.mdPO«W<html><head><style id="style-1-cropbar-clipper">/* Copyright 2014 Evernote Corporation. All rights reserved. */
...
</style><style type="text/css"></style></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;"># EOS.IO Technical White Paper
...
</pre></body></html>Ztext/plainUUTF-8    ( 7 N ` v î Í Î»F»Q                           »W